...
#le champs 'first_name' doit etre non-nil, ne doit pas etre vide, longueur max 50 car
    validates :first_name, presence: true, length: { maximum: 50 }
#le champs 'last_name' doit etre non-nil, ne doit pas etre vide, longueur max 50 car
